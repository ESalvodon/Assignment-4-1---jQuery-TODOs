...
(0, _jquery2.default)(document).ready(function (e) {
	...
	(0, _jquery2.default)("tbody").on("click", ".cross", function () {
		(0, _jquery2.default)(this).closest("tr").remove();
	});

	(0, _jquery2.default)("button").on("click", getInput);

	(0, _jquery2.default)("tbody").on("click", ".box", function () {
		(0, _jquery2.default)(this).closest("tr").find("span").toggleClass("checked");
	});
});
...
function editButton() {
	(0, _jquery2.default)(".delete").on("click", "span", function () {
		(0, _jquery2.default)(".cross").toggle();
	});
}

// Obtaining customer input and then calling addItem() with the input
function getInput() {
	var custInput = (0, _jquery2.default)(".custinput");
	var input = custInput.val();

	if (input !== "" && _jquery2.default.trim(input) !== "") {
		addItem(input);
		custInput.val("");
	}
}
...
function addItem(message) {
	...
	(0, _jquery2.default)(".cross").hide(); // hiding the delete icon
